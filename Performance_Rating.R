...
Rating08_1 <- Rating08[,c('RIN', 'Performance.Rating..Select.from.Drop.Down.')]
Rating09_1 <- Rating09[,c('RIN', 'Performance.Rating..Select.from.Drop.Down.')]
Rating10_1 <- Rating10[,c('RIN', 'Rating')]
Rating11_1 <- Rating11[,c('RIN', 'Performance.Rating..Select.from.Drop.Down.')]
Rating12_1 <- Rating12[,c('RIN', 'Performance.Rating..Select.from.Drop.Down.')]
Rating13_1 <- Rating13[,c('RIN', 'Performance.Rating..Select.from.Drop.Down.')]
Rating14_1 <- Rating14[,c('RIN', 'Performance.Rating..Select.from.Drop.Down.')]
...
Rating09_CBS <- merge(Rating09_1, CBS_FY08, by = c('RIN'))
Rating10_CBS <- merge(Rating10_1, CBS_FY08, by = c('RIN'))
Rating11_CBS <- merge(Rating11_1, CBS_FY08, by = c('RIN'))
Rating12_CBS <- merge(Rating12_1, CBS_FY08, by = c('RIN'))
Rating13_CBS <- merge(Rating13_1, CBS_FY08, by = c('RIN'))
Rating14_CBS <- merge(Rating14_1, CBS_FY08, by = c('RIN'))
...
Rating_CBS_Pay_extreme <- Rating_CBS_Pay_extrem[, c('RIN', 'Rating_Year', 'Performance_Rating', 'ECLS', 'CITY', 'ST', 'ZIP',
  'CT', 'DOB', 'DOH', 'ACT_PAY', 'JOB.TITLE', 'TS_ORG',
...
Rating_CBS_Pay_extreme_Exempt <- Rating_CBS_Pay_extreme[(Rating_CBS_Pay_extreme$Employee.Exempt.Non.Exempt.Indicator == 'Exempt'),]
Rating_CBS_Pay_extreme_Nonexempt <- Rating_CBS_Pay_extreme[(Rating_CBS_Pay_extreme$Employee.Exempt.Non.Exempt.Indicator == 'Non-Exempt'),]
...
qplot(ECLS, data=Rating_CBS_Pay_extreme_Exempt_e, geom="histogram", fill= as.factor(Rating))+ 
  ggtitle("Exempt Employee without Normal Grade") +
  theme(text = element_text(size = 18, family="Impact"))  
...
s1/s2
plot(s1/s2, type = "l", col = "red", xlab = "HOL_PAID", ylab = "Best Rating Rate", main = "Exempt Employee")
...
summary(as.factor(Rating_CBS_Pay_extreme_Exempt$HOL_PAID))
s1/s2
plot(s1/s2, type = "l", col = "red", xlab = "HOL_PAID", ylab = "Worst Rating Rate", main = "Exempt Employee")
...
s2 <- summary(as.factor(Rating_CBS_Pay_extreme_Exempt[(Rating_CBS_Pay_extreme_Exempt$Age < 69),] $Age))
summary(as.factor(Rating_CBS_Pay_extreme_Exempt[(Rating_CBS_Pay_extreme_Exempt$Rating == 'Best'),]$Age))
summary(as.factor(Rating_CBS_Pay_extreme_Exempt[(Rating_CBS_Pay_extreme_Exempt$Age < 69),] $Age))
s1/s2
plot(s1/s2, type = "l", col = "red", xlab = "Age", ylab = "Best Rating Rate", main = "Exempt Employee")
...
s2 <- summary(as.factor(Rating_CBS_Pay_extreme_Exempt[(Rating_CBS_Pay_extreme_Exempt$Age < 71),] $Age))
summary(as.factor(Rating_CBS_Pay_extreme_Exempt[(Rating_CBS_Pay_extreme_Exempt$Rating == 'Worst'),]$Age))
summary(as.factor(Rating_CBS_Pay_extreme_Exempt[(Rating_CBS_Pay_extreme_Exempt$Age < 71),] $Age))
s1/s2
plot(s1/s2, type = "l", col = "red", xlab = "Age", ylab = "Worst Rating Rate", main = "Exempt Employee")
...
s1/s2
plot(s1/s2, type = "l", col = "red", xlab = "ACT_PAY", ylab = "Best Rating Rate", main = "Exempt Employee")
...
summary(as.factor(Rating_CBS_Pay_extreme_Exempt$ACT_PAY))
s1/s2
plot(s1/s2, type = "l", col = "red", xlab = "ACT_PAY", ylab = "Worst Rating Rate", main = "Exempt Employee")
...
s1/s2
plot(s1/s2, type = "l", col = "red", xlab = "Year_of_Service", ylab = "Best Rating Rate", main = "Exempt Employee")
...
s2 <- summary(as.factor(Rating_CBS_Pay_extreme_Exempt$Year_of_Service))
summary(as.factor(Rating_CBS_Pay_extreme_Exempt[(Rating_CBS_Pay_extreme_Exempt$Rating == 'Worst'),]$Year_of_Service))
summary(as.factor(Rating_CBS_Pay_extreme_Exempt$Year_of_Service))
s1/s2
plot(s1/s2, type = "l", col = "red", xlab = "Year_of_Service", ylab = "Worst Rating Rate", main = "Exempt Employee")
...
s1/s2
plot(s1/s2, type = "l", col = "red", xlab = "Ethnicity", ylab = "Best Rating Rate", main = "Exempt Employee")
...
summary(as.factor(Rating_CBS_Pay_extreme_Exempt$Ethnicity))
s1/s2
plot(s1/s2, type = "l", col = "red", xlab = "Ethnicity", ylab = "Worst Rating Rate", main = "Exempt Employee")
...
s1/s2
plot(s1/s2, type = "l", col = "red", xlab = "Job.Hourly.Rate", ylab = "Best Rating Rate", main = "Exempt Employee")
...
summary(as.factor(Rating_CBS_Pay_extreme_Exempt$Job.Hourly.Rate))
s1/s2
plot(s1/s2, type = "l", col = "red", xlab = "Job.Hourly.Rate", ylab = "Worst Rating Rate", main = "Exempt Employee")
...
s2 <- summary(as.factor(Rating_CBS_Pay_extreme_Exempt[(Rating_CBS_Pay_extreme_Exempt$YOB > 1942),] $YOB))
summary(as.factor(Rating_CBS_Pay_extreme_Exempt[(Rating_CBS_Pay_extreme_Exempt$Rating == 'Best'),]$YOB))
summary(as.factor(Rating_CBS_Pay_extreme_Exempt[(Rating_CBS_Pay_extreme_Exempt$YOB > 1942),] $YOB))
s1/s2
plot(s1/s2, type = "l", col = "red", xlab = "YOB", ylab = "Best Rating Rate", main = "Exempt Employee")
...
s2 <- summary(as.factor(Rating_CBS_Pay_extreme_Exempt[(Rating_CBS_Pay_extreme_Exempt$YOB > 1937),] $YOB))
summary(as.factor(Rating_CBS_Pay_extreme_Exempt[(Rating_CBS_Pay_extreme_Exempt$Rating == 'Worst'),]$YOB))
summary(as.factor(Rating_CBS_Pay_extreme_Exempt[(Rating_CBS_Pay_extreme_Exempt$YOB > 1937),] $YOB))
s1/s2
plot(s1/s2, type = "l", col = "red", xlab = "YOB", ylab = "Worst Rating Rate", main = "Exempt Employee")
...
s2 <- summary(as.factor(Rating_CBS_Pay_extreme_Exempt[(Rating_CBS_Pay_extreme_Exempt$YOH >= 1969),] $YOH))
summary(as.factor(Rating_CBS_Pay_extreme_Exempt[(Rating_CBS_Pay_extreme_Exempt$Rating == 'Best'),]$YOH))
summary(as.factor(Rating_CBS_Pay_extreme_Exempt[(Rating_CBS_Pay_extreme_Exempt$YOH >= 1969),] $YOH))
s1/s2
plot(s1/s2, type = "l", col = "red", xlab = "YOH", ylab = "Best Rating Rate", main = "Exempt Employee")
...
s2 <- summary(as.factor(Rating_CBS_Pay_extreme_Exempt$YOH))
summary(as.factor(Rating_CBS_Pay_extreme_Exempt[(Rating_CBS_Pay_extreme_Exempt$Rating == 'Worst'),]$YOH))
summary(as.factor(Rating_CBS_Pay_extreme_Exempt$YOH))
s1/s2
plot(s1/s2, type = "l", col = "red", xlab = "YOH", ylab = "Worst Rating Rate", main = "Exempt Employee")
...
# qplot(as.factor(Rating), data=Rating_CBS_Pay_extreme_Nonexempt, geom="histogram", fill=Portfolio.Title)+ 
#   ggtitle("All Exempt Employee") +
#   theme(text = element_text(size = 18, family="Impact"))
...
qplot(ECLS, data=Rating_CBS_Pay_extreme_Nonexempt_e, geom="histogram", fill= as.factor(Rating))+ 
  ggtitle("Non-Exempt Employee without Normal Grade") +
  theme(text = element_text(size = 18, family="Impact"))  
...
s2 <- summary(as.factor(Rating_CBS_Pay_extreme_Nonexempt[(Rating_CBS_Pay_extreme_Nonexempt$Age < 71),] $Age))
summary(as.factor(Rating_CBS_Pay_extreme_Nonexempt[(Rating_CBS_Pay_extreme_Nonexempt$Rating == 'Best'),]$Age))
summary(as.factor(Rating_CBS_Pay_extreme_Nonexempt[(Rating_CBS_Pay_extreme_Nonexempt$Age < 71),] $Age))
s1/s2
plot(s1/s2, type = "l", col = "red", xlab = "Age", ylab = "Best Rating Rate", main = "Exempt Employee")
...
s2 <- summary(as.factor(Rating_CBS_Pay_extreme_Nonexempt[(Rating_CBS_Pay_extreme_Nonexempt$Year_of_Service < 36),] $Year_of_Service))
summary(as.factor(Rating_CBS_Pay_extreme_Nonexempt[(Rating_CBS_Pay_extreme_Nonexempt$Rating == 'Worst'),]$Year_of_Service))
summary(as.factor(Rating_CBS_Pay_extreme_Nonexempt[(Rating_CBS_Pay_extreme_Nonexempt$Year_of_Service < 36),] $Year_of_Service))
s1/s2
plot(s1/s2, type = "l", col = "red", xlab = "Year_of_Service", ylab = "Worst Rating Rate", main = "Exempt Employee")
...
s1/s2
plot(s1/s2, type = "l", col = "red", xlab = "Ethnicity", ylab = "Best Rating Rate", main = "Non-Exempt Employee")
...
s2 <- summary(as.factor(Rating_CBS_Pay_extreme_Nonexempt[(Rating_CBS_Pay_extreme_Nonexempt$YOB > 1943),][(Rating_CBS_Pay_extreme_Nonexempt$YOB < 1985),] $YOB))
summary(as.factor(Rating_CBS_Pay_extreme_Nonexempt[(Rating_CBS_Pay_extreme_Nonexempt$Rating == 'Worst'),]$YOB))
summary(as.factor(Rating_CBS_Pay_extreme_Nonexempt[(Rating_CBS_Pay_extreme_Nonexempt$YOB > 1943),][(Rating_CBS_Pay_extreme_Nonexempt$YOB < 1985),] $YOB))
s1/s2
plot(s1/s2, type = "l", col = "red", xlab = "YOB", ylab = "Worst Rating Rate", main = "Exempt Employee")
